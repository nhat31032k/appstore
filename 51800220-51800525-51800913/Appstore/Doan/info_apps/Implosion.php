    ...
    <div class="border-info">
      <div class="table-info">
        <div class="inside-table">
          <div class="img-info">
            <img src="../images/apps/hotgame/16.webp">
          </div>
          <div class="writing-film">
            <div class="inside-writing">
              <div class="row-writing">
                <h1 class="title">Implosion</h1>
                <div class="time-star">
                  <div class="time-cell">
                    <div class="time-info">
                      <a href="#" class="director-app name-app">Rayark</a>
                      <br>
                  ...
                  <div class="star-cell">
                    <div class="star">
                      ...
                      <span class="people-rate">40</span>
        ...
        <div class="img-product">
          <img class="title-img" src="../images/apps/hotgame/16-1.webp">
        </div>
