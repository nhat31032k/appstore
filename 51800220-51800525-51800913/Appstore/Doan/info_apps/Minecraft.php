    ...
    <div class="border-info">
      <div class="table-info">
        <div class="inside-table">
          <div class="img-info">
            <img src="../images/apps/hotgame/5.webp">
          </div>
            ...
            <div class="inside-writing">
              <div class="row-writing">
                ...
                <div class="time-star">
                  <div class="time-cell">
                    <div class="time-info">
                      <a href="#" class="director-app name-app">Mojang</a>
                      <br>
                  ...
                  <div class="borrow-buy">
                    <div class="block-button">
                      <span class="install-button">
                        <button class="install" onclick="" id="install" type="button"> 166.699đ mua</button>
                      </span>
        ...
        <div class="img-product">
          <img class="title-img" src="../images/apps/hotgame/5-1.webp">
        </div>
