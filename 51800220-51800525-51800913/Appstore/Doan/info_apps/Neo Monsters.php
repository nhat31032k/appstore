    ...
    <div class="border-info">
      <div class="table-info">
        <div class="inside-table">
          <div class="img-info">
            <img src="../images/apps/hotgame/14.webp">
          </div>
          <div class="writing-film">
            <div class="inside-writing">
              <div class="row-writing">
                <h1 class="title">Neo Monsters</h1>
                <div class="time-star">
                  <div class="time-cell">
                    <div class="time-info">
                      <a href="#" class="director-app name-app">ZigZaGame</a>
                      <br>
        ...
        <div class="img-product">
          <img class="title-img" src="../images/apps/hotgame/14-1.webp">
        </div>
        ...
        <div class="summary-film">
          <div class="inside-summary">
            <span>
Become a Legend! Capture over 1000 Animated Monsters and Duel in Real-Time PvP!
...
Neo Monsters is an addictive strategy RPG that features epic 4v4 battles between two teams of up to 16 monsters. The unique turn-based battle system allows you to come up with powerful chain strategies by combining hundreds of abilities. Hunt down the strongest monsters and harness their power, then take the battle online to dominate in exciting PvP battles and leagues! Are you ready to take the challenge?
          ...
          Terms of Service:
          <br>
https://www.zigzagame.com/terms-and-conditions/
            </span>
          </div>
        </div>
        <hr>
