    ...
    <div class="border-info">
      <div class="table-info">
        <div class="inside-table">
          <div class="img-info">
            <img src="../images/applications/29.webp">
          </div>
          <div class="writing-film">
            <div class="inside-writing">
              <div class="row-writing">
                <h1 class="title">My Talking Tom</h1>
                <div class="time-star">
                  <div class="time-cell">
                    <div class="time-info">
                      <a href="#" class="director-app name-app"></a>
                      <br>
                      <a href="#" class="director-app">Outfit7 Limited</a>
                    </div>
                  </div>
                  <div class="star-cell">
                    <div class="star">
        ...
        <div class="img-product">
          <img class="title-img" src="../images/applications/29-1.webp">
        </div>
