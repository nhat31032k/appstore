    ...
    <div class="border-info">
      <div class="table-info">
        <div class="inside-table">
          <div class="img-info">
            <img src="../images/apps/hotgame/25.webp">
          </div>
          <div class="writing-film">
            <div class="inside-writing">
              <div class="row-writing">
                <h1 class="title">Astral Fable</h1>
                <div class="time-star">
                  <div class="time-cell">
                    <div class="time-info">
                      <a href="#" class="director-app name-app">EyouGAME</a>
                      <br>
        ...
        <div class="img-product">
          <img class="title-img" src="../images/apps/hotgame/25-1.webp">
        </div>
        ...
        <div class="summary-film">
          <div class="inside-summary">
            <span>
             ●　Chosen as the most recommended app many times in the Play Store
             <br>
●　More than 1 million downloads worldwide
<br>

●　Its adorable style and flamboyant skills will bring you an extraordinary experience
<br>
<br>
