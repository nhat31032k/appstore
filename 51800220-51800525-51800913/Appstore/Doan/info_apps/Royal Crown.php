    ...
    <div class="border-info">
      <div class="table-info">
        <div class="inside-table">
          <div class="img-info">
            <img src="../images/apps/hotgame/19.webp">
          </div>
          <div class="writing-film">
            <div class="inside-writing">
              <div class="row-writing">
                <h1 class="title">Royal Crown</h1>
                <div class="time-star">
                  <div class="time-cell">
                    <div class="time-info">
                      <a href="#" class="director-app name-app">LINEGames Action</a>
                      <br>
        ...
        <div class="img-product">
          <img class="title-img" src="../images/apps/hotgame/19-1.webp">
        </div>
