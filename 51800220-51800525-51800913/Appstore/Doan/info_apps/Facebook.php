    ...
    <div class="border-info">
      <div class="table-info">
        <div class="inside-table">
          <div class="img-info">
            <img src="../images/applications/16.webp">
          </div>
        ...
        <div class="img-product">
          <img class="title-img" src="../images/applications/16-1.webp">
        </div>
...
• Nhận thông báo khi bạn bè thích và bình luận về bài viết của bạn<br>

• Chơi trò chơi và sử dụng các ứng dụng yêu thích<br>
