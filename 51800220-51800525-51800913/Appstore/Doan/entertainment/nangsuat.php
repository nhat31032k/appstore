      ...
      <div class="all-row">
        <div class="row-films">
          <div class="cell-films">
           <a href="../info_apps/Adobe XD.php"> <img src="../images/nangsuat/1.webp"></a>
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="../info_apps/Adobe XD.php">Adobe XD</a>
        ...
        <div class="row-films">
          <div class="cell-films">
            <a href="../info_apps/Adobe Sign.php"><img src="../images/nangsuat/2.webp"></a>
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="../info_apps/Adobe Sign.php">Adobe Sign</a>
                  <a class="games" href="#"><p class="info-movies">ứng dụng</p></a>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <a href="../info_apps/Adobe Scout.php"><img src="../images/nangsuat/3.webp"></a>
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="../info_apps/Adobe Scout.php">Adobe Scout</a>
                  <a class="games" href="#"><p class="info-movies">ứng dụng</p></a>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <a href="../info_apps/Write on PDF.php"><img src="../images/nangsuat/4.webp"></a>
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="../info_apps/Write on PDF.php">Write on PDF</a>
                  <a class="games" href="#"><p class="info-movies">ứng dụng</p></a>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
           <a href="../info_apps/Ai File Viewer.php"><img src="../images/nangsuat/6.webp"></a>
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="../info_apps/Ai File Viewer.php">Ai File Viewer </a>
                  <a class="games" href="#"><p class="info-movies">ứng dụng</p></a>
                </div>
                <div class="rate-price">
                  <div class="star">
