  ...
  <div class="content-r">
    ...
    <div class="table-films">
      ...
      <div class="all-row">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/2.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Twilight</a>
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/3.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">The Twilight</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/4.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Twiligh(Extended)</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/5.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">The Twilight Saga</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/6.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Kingsman</a>
                  <p class="info-movies">Hành động và phiêu lưu</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/7.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Maze Runner</a>
                  <p class="info-movies">Âm thanh tiếng tiếng Hàn</p>
                </div>
                <div class="rate-price">
                  <div class="star">
                    <span class="fa fa-star checked"></span>
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/8.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Wonder woman</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/9.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Bohemian Rhapsody</a>
                  <p class="info-movies">Kịch</p>
                </div>
                <div class="rate-price">
                  <div class="star">
                    <span class="fa fa-star checked"></span>
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/10.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Sider-Man</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/11.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">The hobbit</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/12.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Kung Fu Panda 3</a>
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/13.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Marvel Studios</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/14.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">The Twilight Saga</a>
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/15.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Suicide Squad</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/16.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">The hobbit</a>
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/17.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">The Angry Bird 2</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/18.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Zootopia</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/19.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">Armageddon</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
        ...
        <div class="row-films">
          <div class="cell-films">
            <img src="../images/films/film-sell/20.webp">
            <div class="padding-films">
              <div class="info-films">
                <div class="advertise-movies">
                  <a class="movies" href="#">A Quiet Place</a>
                  <p class="info-movies">Âm thanh tiếng Tiếng Anh</p>
                </div>
                <div class="rate-price">
                  <div class="star">
