...
<script type="text/javascript" src="Doan/js/click_films_page.js"></script>
<script type="text/javascript" src="Doan/js/click_hotgame.js"></script>
<script type="text/javascript" src="Doan/js/click_phim_moi.js"></script>
<script type="text/javascript" src="Doan/js/click_dexuat_film.js"></script>
<body>

<!-- Header -->
<table class="header">
  <tr>
    <td><a href="?controller=entertainment&action=index"><img id="header" src="Doan/images/apple-store-493161.png" height="60" width="60"></a></td>
    <td>
...
<div class="content">
  ...
  <div class="nav-content-l" id="navbar">
    <div class="nav-l">
      <ul class="nav-l">
        <li class="left-nav"><a class="active-entertainment" class="entertainment" href="?controller=entertainment&action=index"><i class="fa fa-th-list"></i> Giải trí</a></li>
        <li class="left-nav"><a class="application" href="?controller=application&action=index"><i class="fa fa-th-large"></i> Ứng dụng</a></li>
